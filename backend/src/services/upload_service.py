...
# Configure Windows-only Tesseract path
# Railway Linux deployment will use system-installed version
...
# Configure Windows-only Poppler path
# Railway Linux deployment uses installed package automatically
...
"""
        ...
        notice_payload = {
            ...
            "department":
            notice_data["department"],

            "program":
            notice_data["program"],

            "semester":
            notice_data["semester"],
